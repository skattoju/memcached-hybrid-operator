...
import (
	...
	"github.com/example/memcached-hybrid-operator/controllers"
...
func main() {
	...
	flag.StringVar(&leaderElectionID, "leader-election-id", "c37fc04c.example.com", "provide leader election")
